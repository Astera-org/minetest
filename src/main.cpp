...
static void set_allowed_options(OptionList *allowed_options)
{
	...
	allowed_options->insert(std::make_pair("remote-input", ValueSpec(VALUETYPE_FLAG,
			_("Enable user input to be sent from message queue, for AI agent reinforcement learning"))));
